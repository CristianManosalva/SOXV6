...
main(int argc, char *argv[]){
  ...
  1c:	7f 6f                	jg     8d <main+0x8d>
	...
	if(argc < 3)
	d = 0.1;
  1e:	dd 05 70 08 00 00    	fldl   0x870
	n = 1;
  ...
  c5:	0f 85 61 ff ff ff    	jne    2c <main+0x2c>
  cb:	eb bb                	jmp    88 <main+0x88>
	  	printf(1, "child %d created\n", getpid());
  cd:	e8 20 03 00 00       	call   3f2 <getpid>
  d2:	52                   	push   %edx
  d3:	50                   	push   %eax
  d4:	68 5b 08 00 00       	push   $0x85b
  d9:	6a 01                	push   $0x1
  ...
  eb:	d9 05 78 08 00 00    	flds   0x878
  f1:	df e9                	fucomip %st(1),%st
  f3:	77 f3                	ja     e8 <main+0xe8>
  f5:	dd d8                	fstp   %st(0)
  f7:	eb 8f                	jmp    88 <main+0x88>
	d = 0.1;
  f9:	dd 05 70 08 00 00    	fldl   0x870
	n = 2;
  ff:	bf 02 00 00 00       	mov    $0x2,%edi
	d = 0.1;
 104:	dd 5d e0             	fstpl  -0x20(%ebp)
 107:	e9 20 ff ff ff       	jmp    2c <main+0x2c>
	if(argc < 3)
 10c:	83 fb 02             	cmp    $0x2,%ebx
 10f:	75 9b                	jne    ac <main+0xac>
	d = 0.1;
 111:	dd 05 70 08 00 00    	fldl   0x870
 117:	dd 5d e0             	fstpl  -0x20(%ebp)
 11a:	eb a7                	jmp    c3 <main+0xc3>
...
printf(int fd, char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
 ...
 6a1:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 34 0b 00 00       	mov    %eax,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 34 0b 00 00    	cmp    %eax,0xb34
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 38 0b 00 00       	mov    $0xb38,%eax
 809:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 810:	00 00 00 
